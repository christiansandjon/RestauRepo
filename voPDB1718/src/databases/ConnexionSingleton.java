...
public final class ConnexionSingleton {
	...
	private static Connection connexionDB = null;
	...
	private static IConnexionInfos infosConnexion = null;
	// new ConnexionFromFile("./ressources/connexion.properties");
	// new ConnexionDBParking();
